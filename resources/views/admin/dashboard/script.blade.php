<script>
    ...
    (function() {
        ...
        const averageDailySalesEl = document.querySelector('#averageDailySales'),
            averageDailySalesConfig = {
                ...
                }, // enable tooltip to inspect values
                responsive: [{
                        breakpoint: 1387,
                        options: {
                            chart: {
    ...
    if (topSocietiesProvidersChartEl) {
        ...
        const topSocietiesProvidersChart = new ApexCharts(topSocietiesProvidersChartEl,
            topSocietiesProvidersChartConfig);
        ...
        var dt_project = new DataTable(dt_project_table, {
            ...
            columnDefs: [{
              ...
              <div class="d-flex align-items-center">
                <ul class="mb-0 list-unstyled d-flex align-items-center avatar-group z-2">
                  ${teamItem}
                </ul>
              </div>
            `;
